...
export const strategy2026: StrategyItem[] = [
  ...
  },
  {
    ...
    pillar: 'AI 布局',
    title: 'AI人才战略布局',
    description: '构建与友商差异化竞争壁垒。通过“内培外引”双轮驱动，将团队从“人力交付”升级为“智能交付”。',
    tactics: [
      '存量重塑：成立AI专项技术小组，负责对在职人员进行工具赋能，强制要求AI工具在交付场景的实操落地。',
      '增量筑基：新入职招聘优先录用AI复合型人才，提前储备核心竞争力，构建行业技术影响力。'
    ],
    kpi: 'AI工具全员渗透率100%; 新进人员AI技能达标率100%'
  },
  {
    id: 's4',
    pillar: '利润优化',
  ...
  },
  {
    ...
    pillar: '数据驱动',
    title: '数据驱动科学管理',
    description: '针对管理粗放痛点，构建数字化精细运营体系。以数据为抓手，实现从“人管人”到“数据管人”，从“事后复盘”到“事前预警”。',
    tactics: [
      '基地穿透管理：建立《基地人均产值日报》，监控现场经理管理动作有效性与作业员人均产出，确保“工时=结算值”。',
      '全景风险监控：建立项目风险驾驶舱，实时抓取客户现场满意度、员工效能及结算差异，消除管理盲区。',
      '效能红线机制：设定远程基地人效与满意度双重红线，数据异常即时干预，拒绝“大概/可能”的主观汇报。'
    ],
    kpi: '人均产值提升15%; 结算差异率<1%; 风险预警覆盖率100%'
  },
  {
    id: 's6',
    pillar: '价值跃迁',
    title: '价值跃迁：交付资产化',
    description: '解决“铁打营盘流水兵”的痛点，将“个人经验”转化为“公司资产”，摆脱单一“人力租赁”模式，构建竞争护城河。',
    tactics: [
      '知识库建设：将平安/百度项目SOP、排错指南、业务逻辑文档化，建立部门级知识库(Wiki)，新人上手周期缩短30%。',
      '标杆案例包装：产出3份行业解决方案白皮书（车险/高精地图/游戏测试），辅助售前打单，展示专家级能力。',
      '专家池构建：选拔10名业务专家（SME），介入新项目前期咨询，从“被动接单”转向“主动赋能”。'
    ],
    kpi: '输出3份标准化解决方案; 沉淀核心资产文档50+份'
  }
];
